...
def draw_end_menu(surface, game):
    ...
    pygame.draw.rect(surface.py_surface, colors["Black"], pygame.Rect(x_rect1+1, y_rect1+1, button_width - 2, button_height - 2 ))
    pygame.draw.rect(surface.py_surface, colors["ivoire"], pygame.Rect(x_rect1+5, y_rect1+5, button_width - 10, button_height - 10))
    pygame.draw.rect(surface.py_surface, colors["darkblue"], pygame.Rect(x_rect1+6,y_rect1+6, button_width - 12, button_height - 12 ))
    ...
    pygame.draw.rect(surface.py_surface, colors["Black"], pygame.Rect(x_rect2+1, y_rect2+1, button_width - 2, button_height - 2 ))
    pygame.draw.rect(surface.py_surface, colors["ivoire"], pygame.Rect(x_rect2+5, y_rect2+5, button_width - 10, button_height - 10))
    pygame.draw.rect(surface.py_surface, colors["darkblue"], pygame.Rect(x_rect2+6,y_rect2+6, button_width - 12, button_height - 12 ))
    ...
    if pygame.Rect(x_rect1, y_rect1, button_width , button_height).collidepoint(pygame.mouse.get_pos()):
        ...
        pygame.draw.rect(surface.py_surface, colors["Black"], pygame.Rect(x_rect1+1, y_rect1+1, button_width - 2, button_height - 2 ))
        pygame.draw.rect(surface.py_surface, colors["ivoire"], pygame.Rect(x_rect1+5, y_rect1+5, button_width - 10, button_height - 10))
        pygame.draw.rect(surface.py_surface, colors["Volkswagen Taupe"], pygame.Rect(x_rect1+6,y_rect1+6, button_width - 12, button_height - 12 ))
    ...
    if pygame.Rect(x_rect2, y_rect2, button_width , button_height).collidepoint(pygame.mouse.get_pos()):
        ...
        pygame.draw.rect(surface.py_surface, colors["Black"], pygame.Rect(x_rect2+1, y_rect2+1, button_width - 2, button_height - 2 ))
        pygame.draw.rect(surface.py_surface, colors["ivoire"], pygame.Rect(x_rect2+5, y_rect2+5, button_width - 10, button_height - 10))
        pygame.draw.rect(surface.py_surface, colors["Volkswagen Taupe"], pygame.Rect(x_rect2+6,y_rect2+6, button_width - 12, button_height - 12 ))
