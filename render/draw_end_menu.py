...
def draw_end_menu(surface):
    ...
    pygame.draw.rect(surface.py_surface, colors["darkblue"], pygame.Rect(x_position, y_position, width, height))
    ...
    surface.py_surface.blit(victory, (x_position + (width - victory.get_width()) / 2, y_position + 50))
    surface.py_surface.blit(info1, (x_position + (width - info1.get_width()) / 2, y_position + 150))
